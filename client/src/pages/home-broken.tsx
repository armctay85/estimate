...
export default function Home() {
  ...
  const [showDashboard, setShowDashboard] = useState(false); // Always go directly to workspace
  ...
  // DASHBOARD REMOVED - Users go directly to workspace with tier-based functionality
                    </div>
